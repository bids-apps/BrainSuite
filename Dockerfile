...
## install FSL
RUN wget -O- https://fsl.fmrib.ox.ac.uk/fsldownloads/fslinstaller.py | tee fslinstaller.py
#RUN /usr/bin/python fslinstaller.py -q -d /usr/share/fsl
#RUN apt-get update && \
#    apt-get install -y curl && \
#    curl -sSL http://neuro.debian.net/lists/xenial.us-ca.full >> /etc/apt/sources.list.d/neurodebian.sources.list && \
#    wget -O- http://neuro.debian.net/lists/bionic.us-ca.libre | tee /etc/apt/sources.list.d/neurodebian.sources.list && \
